...
bool initVulkan()
{
	...
	if (!createDescriptorPool(vkDev, 1, 2, 1, &vkState.descriptorPool) ||
		...
		!createGraphicsPipeline(vkDev, vkState.renderPass, vkState.pipelineLayout, { "data/shaders/chapter3/VK02.vert", "data/shaders/chapter3/VK02.frag", "data/shaders/chapter3/VK02.geom" }, &vkState.graphicsPipeline))
	{
