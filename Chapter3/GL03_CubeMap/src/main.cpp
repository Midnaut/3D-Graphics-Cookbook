...
int main(void)
{
	...
	GLShader shdModelVertex("data/shaders/chapter3/GL03_duck.vert");
	GLShader shdModelFragment("data/shaders/chapter3/GL03_duck.frag");
	GLProgram progModel(shdModelVertex, shdModelFragment);

	GLShader shdCubeVertex("data/shaders/chapter3/GL03_cube.vert");
	GLShader shdCubeFragment("data/shaders/chapter3/GL03_cube.frag");
