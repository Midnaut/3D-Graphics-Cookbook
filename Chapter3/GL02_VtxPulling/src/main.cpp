...
int main(void) {
	...
	GLShader shaderVertex("data/shaders/chapter3/GL02.vert");
	GLShader shaderGeometry("data/shaders/chapter3/GL02.geom");
	GLShader shaderFragment("data/shaders/chapter3/GL02.frag");
	...
	const size_t kSizeVerts = sizeof(VertexData) * verts.size();
	...
	glNamedBufferStorage(dataVertices, kSizeVerts, verts.data(), 0);
